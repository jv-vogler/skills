...
| [`plan`](./plugins/plan) | 1.0.0 | developer-tools | Use when planning a new feature, refactor, package upgrade, migration, or design, architecture, or infrastructure change — and when executing the resulting plan. `plan:write`… |
