...
How code gets written and landed, whatever the work came from.

## Skills

### `code:implement`

The standard applied to every line written — names that spell out meaning, early returns,
